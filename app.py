...
def login():
    ...
    if request.method == 'POST':
        ...
        if user and user['password'] == password:
            ...
            return render_template('login.html', error="Nombre de usuario o contraseña inválidos.")
...
def register():
    ...
    save_db(db)
    session['username'] = username
    return render_template('login.html', success="Nombre de usuario creado con éxito.")
